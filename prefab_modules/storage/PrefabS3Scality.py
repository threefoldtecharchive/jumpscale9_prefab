...
class PrefabS3Scality(app):
    ...
    def install(self, start=False, storageLocation="/data/", metaLocation="/meta/"):
        ...
        self.prefab.core.dir_remove('{DIR_BASE}/apps/S3', recursive=True)
        self.prefab.core.dir_ensure('{DIR_BASE}/apps/')
        self.prefab.core.run('mv {} {DIR_BASE}/apps/'.format(path))
        ...
        content = self.prefab.core.file_read('{DIR_BASE}/apps/S3/package.json')
        ...
        self.prefab.core.file_write('{DIR_BASE}/apps/S3/package.json', content)
    ...
    def start(self, name=NAME):
        ...
        nodePath = self.prefab.core.replace('{DIR_BASE}/node/lib/node_modules/s3/node_modules:%s' % nodePath)
