...
class PrefabPEP8(base):
    ...
    def prepare(self, repo_path=None):
        ...
        for repo_path in paths:
            self.prefab.core.file_write(repo_path, hook_cmd)
    ...
    def autopep8(self, repo_path=None, commit=True, rebase=False):
        ...
        for repo_path in paths:
            self.prefab.core.execute_script(cmd.format(repo_path), tmux=False, die=False)
