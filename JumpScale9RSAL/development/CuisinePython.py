...
class CuisinePython(base):
    ...
    def build(self, reset=False):
        ...
        self.cuisine.core.copyTree(source=lpath, dest=self.BUILDDIRL, keepsymlinks=True, deletefirst=False,
        ...
        self.cuisine.core.copyTree(source=lpath, dest=ldest, keepsymlinks=True, deletefirst=False,
        ...
        self.cuisine.core.copyTree(source=self.cuisine.development.openssl.BUILDDIRL, dest=self.BUILDDIRL,
    ...
    def sandbox(self, reset=False, deps=True):
        ...
        # self.cuisine.core.copyTree(source=self.BUILDDIRL, dest=destpath2, keepsymlinks=False, deletefirst=True,
        #                            overwriteFiles=True,
        #                            recursive=True, rsyncdelete=True, createdir=True)
