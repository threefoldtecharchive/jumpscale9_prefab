...
class CuisineJSAgent(app):
    ...
    def install(self, start=False, gid=1, ctrl_addr='', ctrl_port=4444, ctrl_passwd='', reset=False):
        ...
        self.cuisine.core.file_link('$CODEDIR/github/jumpscale/jumpscale_core9/apps/jsagent', '$JSAPPSDIR/jsagent')
        if start is True:
    ...
    def start(self, gid, ctrl_addr, ctrl_port=4444, ctrl_passwd=''):
        ...
        self.cuisine.processmanager.ensure(name="jsagent", cmd=cmd, path='$JSAPPSDIR/jsagent')
