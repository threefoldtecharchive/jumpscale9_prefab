...
class Disks:
    """This class give you access to disk related actions from the kvm sal over prefab"""
    ...
    def download_image(self, url, overwrite=False):
        ...
        self._controller.executor.prefab.core.file_download(url, path, overwrite=True)
