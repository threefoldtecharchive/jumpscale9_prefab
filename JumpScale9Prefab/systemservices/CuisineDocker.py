...
from JumpScale.tools.prefab.CuisinePackage import LOCK_NAME, LOCK_TIMEOUT
import random
...
class CuisineDocker(app):
    ...
    def dockerStart(self, name="ubuntu1", image='jumpscale/ubuntu1604',
        ...
        """
        will return dockerCuisineObj: is again a prefab obj on which all kinds of actions can be executed
        ...
        host = out
        dockerexecutor = Cuisinedockerobj(name, host, "22", self.prefab)
