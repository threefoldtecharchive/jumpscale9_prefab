...
class Machines:
    """This class give you access to machine related actions from the kvm sal over cuisine"""
    ...
    def create(self, name, os='xenial-server-cloudimg-amd64-uefi1.img',
        ...
        @param nics [str]: name of networks to be used with machine. need to be created before. (cuisine.systemservices.kvm.networks.create())
