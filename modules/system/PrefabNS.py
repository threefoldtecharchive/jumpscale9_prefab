...
class PrefabNS(base):
    ...
    def hostfile_get(self):
        ...
        """
        result = {}
        for line in self.prefab.core.hostfile.splitlines():
    ...
    def nameservers(self):
        ...
        """
        file = self.prefab.core.file_read('/etc/resolv.conf')
        results = []
    ...
    def nameservers(self, nameservers=[]):
        ...
        self.prefab.core.file_write('/etc/resolv.conf', content)
