...
class PrefabRedis(app):
    ...
    def start(self, name="main", ip="localhost", port=6379, max_ram="50mb", append_only=True,
        ...
        if unixsocket is not None:
            ...
            self.prefab.core.dir_ensure(redis_socket)
    ...
    def is_running(self, ip_address='localhost', port=6379, path='$BINDIR', password=None, unixsocket=None):
        ...
        ping_cmd += ' ping'
        rc, out, err = self.prefab.core.run(ping_cmd, die=False)
    ...
    def empty_instance(self, name):
        ...
        self.prefab.core.dir_remove(d_path)
        self.prefab.core.dir_ensure(d_path)
    ...
    def configure_instance(self, name, ip="localhost", port=6379, max_ram="1048576", append_only=True,
        ...
        self.prefab.core.dir_ensure(db_path)
        self.prefab.core.file_write(c_path, config)
